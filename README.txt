For information on data procurement, consult report.
...
Planes and Slices: Another file for data augmentation strategy for research arc 2
Xtal2Png creator: File for creating, storing, sorting and labeling XTAL2PNG images.
propertyPrediction: training script with arguments for training CNNs to regress on images and predict properties
